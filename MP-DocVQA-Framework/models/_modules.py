...
class SpatialEmbeddings(nn.Module):
    ...
    def forward(self, bbox):
        # print("DEBUG - SpatialEmbeddings.forward: bbox shape =>", bbox.shape)
        # print("DEBUG - SpatialEmbeddings.forward: bbox device =>", bbox.device)
        # print("DEBUG - SpatialEmbeddings.forward: bbox dtype =>", bbox.dtype)
        # print("DEBUG - SpatialEmbeddings.forward: x_position_embeddings weight device =>", self.x_position_embeddings.weight.device)
        # print("DEBUG - SpatialEmbeddings.forward: x_position_embeddings weight shape =>", self.x_position_embeddings.weight.shape)
        ...
        # print("DEBUG - SpatialEmbeddings: bbox device:", bbox.device)
        # print("DEBUG - SpatialEmbeddings: x_position_embeddings device:", self.x_position_embeddings.weight.device)
