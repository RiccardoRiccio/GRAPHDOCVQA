...
class HybridVT5GraphDoc:
    ...
    def __init__(self, config):
        ...
        # Load a fresh T5 model (base version)
        print("[HybridVT5GraphDoc] Loading fresh T5-base model.")
        base_config = T5Config.from_pretrained("t5-base")
        fresh_t5 = T5ForConditionalGeneration.from_pretrained("t5-base", config=base_config)

        # Replace the encoder and decoder in ProxyVT5
        print("[HybridVT5GraphDoc] Replacing encoder and decoder with fresh components.")
        self.vt5.model.encoder = fresh_t5.encoder
        self.vt5.model.decoder = fresh_t5.decoder
        ...
        # Use the tokenizer from T5-base
    ...
    def forward(self, batch, return_pred_answer=False, return_confidence=False):
        ...
        # Debug prints for concatenated embeddings
        # print("Question Encoder Output Shape:", question_enc.shape)
        # print("Padded Document Embeds Shape:", padded_doc_embeds.shape)
        # print("Final Concatenated Embeddings Shape:", final_enc.shape)
...
def main():
    ...
    config_file = "config/models/finetune_vt5+graphdoc_FRESH.yml"
